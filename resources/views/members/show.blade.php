...
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">સભ્યની વિગતો</li>
        </ol>
    </nav>
...
<div class="row" data-member-show-page data-api-show-url="{{ route('api.members.show', $member) }}" data-family-edit-template="{{ route('family-members.edit', [$member, '__FAMILY__']) }}" data-family-delete-template="{{ route('api.members.family-members.destroy', [$member, '__FAMILY__']) }}" data-reload-url="{{ route('members.show', $member) }}">
    <div class="col-md-4">
        <div class="card h-100 shadow-sm border-0">
            <div class="card-body text-center">
                <div data-member-photo-wrapper>
                @if($member->photo)
                    <img src="{{ asset('storage/' . $member->photo) }}" alt="" class="rounded-circle mb-3 border p-1" width="150" height="150" style="object-fit: cover;">
                @else
    ...
    <div class="col-md-8">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white border-bottom-0 pt-3 d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-sm btn-success px-3" data-bs-toggle="modal" data-bs-target="#addFamilyMemberModal">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody data-member-family-rows>
                            @forelse($member->children as $family)
                                <tr>
                                    ...
                                    <td><span class="badge bg-light text-dark border">{{ $family->relation }}</span></td>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="pincode" id="modal_pincode" class="form-control" required>
                        </div>
